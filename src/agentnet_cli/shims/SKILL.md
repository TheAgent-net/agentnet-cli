...
| `agentnet skills discover <use_case>` | AI-powered skill discovery across all sources (`--limit`) |
| `agentnet skills search <query>` | Search for AI agent skills on skills.sh (default) or SkillsMP (`--source skillsmp`) |
